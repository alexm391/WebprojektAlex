...
namespace Webanwendung.Models
{
    ...
    public class Booking
    {
        ...
        public Booking() : this(-1, 0, 0, DateTime.MaxValue, DateTime.MaxValue, 0, 0m, 0m, 0m, 0m, 0, null) { }
        public Booking(int id, int idUser, int roomNr, DateTime startDate, DateTime endDate, Beds beds, decimal price1, 
            decimal price2, decimal price3, decimal priceForStay, int duration, User user)
        {
            this.ID = id;
            this.IdUser = idUser;
            this.RoomNr = roomNr;
